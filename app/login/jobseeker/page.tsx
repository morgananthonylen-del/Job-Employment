...
export default function JobSeekerLoginPage() {
  ...
  useEffect(() => {
    if (JOBSEEKER_TESTIMONIALS.length <= 1) return;
        ...
        <div ref={cardRef} className="flex-1 flex flex-col justify-center">
          <div className="space-y-2 pb-6 text-center">
            <div className="flex items-center justify-center gap-2">
              ...
              <h2 className="text-xl font-semibold text-gray-900 lg:text-white">Job Seeker Login</h2>
            </div>
          </div>
    ...
    <div className={`min-h-screen bg-white lg:bg-purple-600 flex items-center justify-center p-4 lg:p-8 ${roboto.className}`}>
       <div className="flex w-full max-w-5xl flex-col gap-8">
        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-between">
          <Card ref={cardRef} className="w-full lg:max-w-xl shadow-2xl border border-gray-200 bg-white rounded-none drop-shadow-lg" data-login-type="jobseeker">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-base text-gray-600" data-role="jobseeker">
