        ...
        <section className="space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-4 text-gray-700">
            <div className="rounded-lg border border-gray-200 p-4">
              ...
              <p>Discounts, bundle deals, limited-time offers, clearance, flash sales.</p>
            </div>
            <div className="rounded-lg border border-gray-200 p-4">
              <h3 className="font-semibold text-gray-900 mb-2">Events &amp; Openings</h3>
              <p>Grand openings, pop-ups, workshops, demos, launches, meetups.</p>
            </div>
            <div className="rounded-lg border border-gray-200 p-4">
              <h3 className="font-semibold text-gray-900 mb-2">Service Updates</h3>
              <p>New services, expanded hours, delivery zones, seasonal menus.</p>
            </div>
            <div className="rounded-lg border border-gray-200 p-4">
              <h3 className="font-semibold text-gray-900 mb-2">Hiring Callouts</h3>
              <p>Short-term staffing needs, event staffing, seasonal roles.</p>
            </div>
          </div>
        </section>
